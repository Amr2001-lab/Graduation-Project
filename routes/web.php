...
Route::put('/properties/{apartment}', [PropertyController::class, 'update'])->middleware('auth')->name('seller.properties.update');

Route::delete('/seller/images/{image}', [SellerController::class, 'destroyImage'])->middleware('auth')->name('seller.images.destroy');

Route::delete('/properties/{apartment}', [SellerController::class, 'destroy'])->middleware('auth')->name('seller.properties.destroy');

Route::post('/inquiry/{id}/email', [InquiryController::class, 'store'])->middleware('auth')->name('inquiry.store');

Route::delete('/properties/{apartment}/tour', [PropertyController::class, 'removeTour'])->middleware('auth')->name('seller.properties.removeTour');